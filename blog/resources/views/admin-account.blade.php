...
<body>
  ...
  <div class="jumbotron" id="jumbo">
    <div class="container">
      ...
      <div class="row" id="firstThumnailRow">
        ...
        <div class="col-sm-4">
          <a href="admin-create-account.blade.php" class="thumnail">
            <figure>
             <img alt="indormation collection" src="../images/thumb1.png" class="thumImg"> 
           </a>
           <figcaption>Create Account{{"wwwwwwwwwwwwwwwwwwwww"}}</figcaption>
         </figure>
       </div>
       <!--1st column ended-->
     ...
     <!--3rd column strat-->
     <div class="col-sm-4">
      <a href="admin-change-password.blade.php" class="thumnail">
        <figure>
         <img alt="indormation collection" src="../images/thumb1.png" class="thumImg"> 
       </a>
