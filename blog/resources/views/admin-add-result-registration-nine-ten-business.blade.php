...
<body >
	...
	<div class="container">
		...
		<h1 style="font-size:30px;text-align: center; color: white;">[ADD RESULT NINE_TEN BUSINESS]</h1>
	</div>
	...
	<div class="col-sm-10 ">
		...
		<form method="post" action="{{action('AdminAddResult@registrationNineTenBusiness')}}"> 
			{{ csrf_field() }}
			<div class="form-group">
				<div class="input-group">
					...
					<select id="selectClass" class="form-control" name="subject">
						...
						<option value="BusinessContact">Business Contacts</option>
						<option value="CommercialGeography">Commercial Geography</option>
