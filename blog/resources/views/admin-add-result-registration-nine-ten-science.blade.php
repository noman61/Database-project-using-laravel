...
<body >
	...
	<div class="container">
		...
		<h1 style="font-size:30px;text-align: center; color: white;">[ADD RESULT NINE_TEN SCIENCE]</h1>
	</div>
	...
	<div class="col-sm-10 ">
		...
		<form method="post" action="{{action('AdminAddResult@registrationNineTenScience')}}"> 
			{{ csrf_field() }}
