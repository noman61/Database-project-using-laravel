			...
			<div class="row" >
				...
				<div class="col-sm-6 loginClass">
					<div id="change-password-form">
						<br>
						<form method="post" action="{{action('Adminaccount@save')}}" autocomplete="on"">
                      {{ csrf_field() }}
							<div class="col-md-12">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type="text" name="qualification" class="form-control" placeholder="Qualification" maxlength="15" />
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
									<button type="submit" class="btn btn-block btn-primary" name="btn-chnage">Create Account</button>
								</div>
								<div class="col-md-6" >
