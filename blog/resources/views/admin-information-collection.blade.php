...
<div  >
  ...
  <div class="col-sm-6 informationCollection">
    <div id="change-password-form">
      <br>
      <form method="post"  action="{{action('AdminInformationCollection@save')}}" autocomplete="on">
       ...
       <div class="col-md-12">
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" name="student" class="form-control" placeholder="Student Full Name"  required="true" />
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
            <input type="text" name="father" class="form-control" placeholder="Student Father Name" required="true" />
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" name="mother" class="form-control" placeholder="Student Mother Name" required="true"  />
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="number" name="registration" class="form-control" placeholder="Registration Number" maxlength="11" minlength="11"  required="true" />
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="number" name="mobile" class="form-control" placeholder="Mobile Number" maxlength="11" required="true" />
          </div>
        </div>
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <select name="gender" class="form-control" id="selectClass"  required="true">
