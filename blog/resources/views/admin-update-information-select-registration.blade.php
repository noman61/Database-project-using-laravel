			...
			<div class="row" >
				...
				<div class="col-sm-6 loginClass">
					<div id="change-password-form">
						<br>
						<form method="post" action="admin-update-information.blade.php" autocomplete="off">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
									<div class="input-group">
										...
										<input type="number" name="pass" class="form-control" placeholder="Registration number" maxlength="15" />
									</div>
								</div>
								...
								<div class="form-group">
								<div class="col-md-6">
									<button type="submit" class="btn btn-block btn-primary" name="btn-chnage">Updat</button>
								</div>
								<div class="col-md-6" >
