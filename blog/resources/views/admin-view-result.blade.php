...
<head>
  ...
  <link rel="stylesheet" href="{{ URL::asset('own/css/admin/admin-view-result.css') }}" />
...
<body>
  ...
  <div  >
    ...
    <!--2nd column strat-->
    <div class="col-sm-6 viewResult" style="background-color: white;">
      <div>
        <br>


        <form method="post"  action="{{action('AdminViewResult@info')}}" autocomplete="on">
        {{ csrf_field() }}
         ...
         <div class="form-group">
          <div class="input-group">
            ...
            <select name="section"  required="true" class="form-control" id="selectClass">
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><span ><i class="fa fa-sort fa-lg" aria-hidden="true"></i> Sort By</span></span>
            <select name="sort"  required="true" class="form-control" id="selectClass">
         ...
         <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><span ><i class="fa fa-sort fa-lg" aria-hidden="true"></i> Order By</span></span>
            <select name="by"  required="true" class="form-control" id="selectClass">
        ...
        <div class="form-group">
          <div class="input-group" style="float: right;">
            <button type="submit" class="btn btn-sreach btn-primary" name="btn-chnage" ><i class="fa  fa-search fa-lg" aria-hidden="true"></i> Search</button>
          </div>
      <br>
        </div>
        <br>
      ...
      <!--form method="post" action="#" autocomplete="off">
        ...
        <div class="form-group">
          <div class="input-group">
            <span class="input-group-addon"><span ><i class="fa  fa-calendar fa-lg" aria-hidden="true"></i> Year</span></span>
            <input type="number" name="year" class="form-control" placeholder="Year" maxlength="11" />
          </div>
        </div>
